...
st.image("https://share.google/Txufv9GaPHlsGYaVn", width=200)

st.markdown("<h1 style='text-align: center; color: #1E3A8A;'>علــش @GX1GX1</h1>", unsafe_allow_html=True)
st.markdown("<p style='text-align: center; font-size: 20px;'>رشــق مشاهدات تيك توك بدون توقـف</p>", unsafe_allow_html=True)
st.write("---")

url_input = st.text_input("رابطـ الفيـديو ", placeholder="الصق الرابط هنا...")

if st.button("بدء التـشغيل ✨"):
    if url_input:
        status_box = st.empty()
